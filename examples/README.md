...
| [`delegation`](delegation) | a dynamic region where the entry agent delegates to a peer, plus the lineage graph, driven by a scripted model via `Options.ModelClient` | yes |
