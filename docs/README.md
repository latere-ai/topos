...
| [Sandboxes](sandboxes.md) | the local provider, a host directory, hosted Cella and its network boundary, the path deny-list, approval before a command runs, and serving a machine as a sandbox |
